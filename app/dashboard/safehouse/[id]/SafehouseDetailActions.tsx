...
import { Lock, MoreVertical, ShieldCheck, ShieldAlert, Edit, Trash2 } from 'lucide-react';
...
export const SafehouseDetailActions: React.FC<SafehouseDetailActionsProps> = ({ id }) => {
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-3 p-4 bg-secondary-container/20 rounded-xl border border-secondary/20">
            ...
            <div>
              ...
              <p className="text-xs text-on-surface-variant">Lokasi ini memenuhi standar keamanan nasional.</p>
            </div>
          </div>

          <div className="space-y-4">
            <h4 className="font-bold text-sm text-primary uppercase tracking-wider">Langkah-langkah Keamanan:</h4>
          ...
          <div className="p-4 bg-error-container/10 rounded-xl border border-dashed border-error/30 flex gap-3">
            ...
            <p className="text-xs text-error font-medium leading-relaxed">
              Pelanggaran protokol keamanan dapat membahayakan nyawa penyintas. Laporkan segera jika terdapat aktivitas mencurigakan di sekitar lokasi.
            </p>
          </div>

          <div className="pt-4 flex justify-end">
            <Button variant="primary" onClick={() => setIsProtocolOpen(false)}>Saya Mengerti</Button>
          </div>
        </div>
      </Modal>
