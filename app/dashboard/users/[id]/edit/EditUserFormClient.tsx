...
export const EditUserFormClient: React.FC<EditUserFormClientProps> = ({
  user,
  onSubmit,
}) => {
    ...
    <Card className="shadow-lg border-t-4 border-t-primary">
      <form action={handleSubmit} className="space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-sm font-semibold text-on-surface flex items-center gap-2">
              <Lock className="w-4 h-4 text-on-surface-variant" /> Ubah Kata
              Sandi (Opsional)
            </label>
            <Input
              name="password"
          ...
          <div className="flex flex-col gap-1">
            <label className="text-sm font-semibold text-on-surface flex items-center gap-2">
              <Shield className="w-4 h-4 text-on-surface-variant" /> Peran /
              Role
            </label>
            <select
              name="role"
          ...
          <div className="flex flex-col gap-1">
            <label className="text-sm font-semibold text-on-surface flex items-center gap-2">
              <Building2 className="w-4 h-4 text-on-surface-variant" /> Unit
              Kerja
            </label>
            <Input
              name="unit"
